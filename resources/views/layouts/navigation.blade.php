                    ...
                    @auth
                        @if (auth()->user()->role === 'supervisor' || auth()->user()->role === 'admin')
                            ...
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('report.transaction.index')">
                                        {{ __('Laporan Penjualan') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('reports.purchases.index')">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if (auth()->user()->role === 'supervisor' || auth()->user()->role === 'admin')
                    ...
                    <!-- Menu Laporan untuk Mobile -->
                    <div class="px-4 py-2 text-xs text-gray-500">
                        {{ __('Laporan') }}
                    </div>
                    <x-responsive-nav-link :href="route('report.transaction.index')" :active="request()->routeIs('report.transaction.*')">
                        {{ __('Laporan Penjualan') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('reports.purchases.index')" :active="request()->routeIs('reports.purchases.*')">
                        {{ __('Laporan Pembelian') }}
                    </x-responsive-nav-link>
                @endif
            @endauth
