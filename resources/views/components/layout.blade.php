          ...
          <ul id="sidebarnav" class="pt-4">
            ...
            <li class="sidebar-item {{ request()->is('inventory/*') ? 'selected' : '' }}">
              ...
              <ul aria-expanded="false" class="collapse first-level {{ request()->is('inventory/*') ? 'in' : '' }}">
                ...
                <li class="sidebar-item {{ request()->is('purchase-requests*') ? 'active' : '' }}">
                  <a href="{{ route('purchase-requests.index') }}" class="sidebar-link">
                    <i class="mdi mdi-file-document"></i>
                    <span class="hide-menu">Purchase Request</span>
                  </a>
                </li>
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a href="{{ route('report.transaction.index') }}"
                    class="sidebar-link {{ request()->is('report/transaction/*') ? 'active' : '' }}">
                ...
                <li class="sidebar-item">
                  <a href="{{ route('reports.purchases.index') }}"
                    class="sidebar-link {{ request()->is('report/purchases/*') ? 'active' : '' }}">
                    <i class="mdi mdi-file-document-box"></i>
